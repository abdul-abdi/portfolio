...
const projects: Project[] = [
  {
    ...
    year: "2024",
    tech: ["Rust", "TypeScript", "EigenLayer", "Solidity"],
  ...
  },
  {
    id: 2,
    title: "GigaCrew",
    category: "Agent-to-Agent Gigs",
    year: "2024",
    tech: ["Eliza", "TypeScript", "AI Agents"],
    color: "from-emerald-600/20 to-teal-600/20",
    wide: true,
  },
  {
    id: 3,
    title: "Circles Plugin",
    category: "Nethermind Plugin",
    year: "2024",
    tech: ["C#", "Nethermind", "RPC"],
  ...
  },
  {
    ...
    year: "2024",
    tech: ["LLM", "Solidity", "Security"],
    color: "from-amber-600/20 to-orange-600/20",
  },
  {
    id: 5,
    title: "PolicyAVS",
    category: "EigenLayer AVS",
    year: "2024",
    tech: ["EigenLayer", "Rust", "Verification"],
  ...
  },
  {
    ...
    year: "2024",
    tech: ["Proof of Agency", "Ethereum", "AI"],
